...
REM ## - %6: Apache Zlib version
REM ## Ex. "2.4.3" "1.4.6" "1.2.1" "1.5.1" "1.0.1c" "1.2.7"
REM ####################
...
"C:\Program Files\7-Zip\7z.exe" x "D:\source\apr\openssl\openssl-%5.7z" -o"C:\source\apache\httpd-%1\srclib\"

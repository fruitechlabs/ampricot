...
// ################################ Global Variables #################################
$apricoreconf = parse_ini_file(str_replace('\\', '/', strstr(__DIR__, 'front', true)) . 'core/inc/apricore.conf');
...
<head>
	...
	<title>Apricore &raquo; Cross-platform web server solution stack package for professional web development.</title>
...
<body>
	...
	<div class="header">
		<div class="inner">
			<div class="content">
				<div class="caption" onclick="location.href=\'http://apricore.fruitechlabs.com/\';">
					<h1 class="title"><a href="http://apricore.fruitechlabs.com/" title="Cross-platform web server solution stack package for professional web development.">Apricore</a></h1>
					<div class="tagline">Cross-platform web server solution stack package for professional web development.</div>
				</div>

				<!-- navigation START -->
				<ul class="navigation">
					<li class="page_item"><a href="http://apricore.fruitechlabs.com/">' . gettext('Homepage') . '</a></li>
					<li class="page_item"><a href="http://apricore.fruitechlabs.com/faq/">' . gettext('FAQ') . '</a></li>
					<li class="page_item"><a href="http://apricore.fruitechlabs.com/documentation/">' . gettext('Documentation') . '</a></li>
					<li class="page_item"><a href="http://apricore.fruitechlabs.com/screenshots/">' . gettext('Screenshots') . '</a></li>
					<li class="page_item"><a href="http://apricore.fruitechlabs.com/download/">' . gettext('Download') . '</a></li>
					<li class="page_item"><a href="http://apricore.fruitechlabs.com/contributors/">' . gettext('Contributors') . '</a></li>
					<li class="page_item"><a href="http://apricore.fruitechlabs.com/contact/">' . gettext('Contact') . '</a></li>
					<li class="page_item"><a href="http://fruitechlabs.com/about/">' . gettext('About Us') . '</a></li>
					<li class="page_item"><a href="http://fruitechlabs.com/support/">' . gettext('Support') . '</a></li>
				</ul>
				<!-- navigation END -->
			</div>
		</div>
		...
		<div class="ccontent">
			...
			<div class="sidebar">
				<div class="sidebarsub">
					...
					<div class="bborder1px"><span class="shade">' . $apricoreconf['apricoreversioncore'] . '</span>Apricore:</div>
					<div><span class="shade">' . $apricoreconf['apricoreversionapache'] . '</span>Apache:</div>
					<div><span class="shade">' . $apricoreconf['apricoreversionmysql'] . '</span>MySQL:</div>
					<div><span class="shade">' . $apricoreconf['apricoreversionphp'] . '</span>PHP:</div>

					<div class="bborder2px">&nbsp;</div>
					<div class="centerpad">' . gettext('Server Status: ') . ucfirst($apricoreconf['apricorestatus']) . '</div>
		...
		<div class="inner">
			<div class="content">
				<span class="floatright">
					<input size="50%" type="text" spellcheck="false" onclick="this.select();" value="@APRICOREINSTALLDIRCORE@/front/data/www/localhost" style="text-align:right;" />
				</span>
